 ...
 */
namespace Juashyam\LogViewer\Controller\Adminhtml\Log;
...
class View extends Action implements HttpGetActionInterface
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Juashyam_LogViewer::log');
        $resultPage->getConfig()->getTitle()->prepend(__('System Log'));
        return $resultPage;
    }
}
